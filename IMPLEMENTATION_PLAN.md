...
Phase 5 Flash business commands are intentionally not implemented.
...
- Complete CCS build integration and real SCI DeviceInfo exchange.
...
- Real App jump and device reset integration.
